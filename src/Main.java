...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<String> operation = Arrays.asList("Добавить", "Показать", "Удалить", "Поиск покупок по ключевым словам");
        List<String> products = Arrays.asList("Молоко", "Хлеб", "Хлебные сушки", "Бургер Родной хлебушек");
